...
# This script invoke command inside kafka container passing --bootstrap-server kafka:9092 argument
...
docker-compose exec kafka "$COMMAND" --bootstrap-server kafka:9092 "$@"
